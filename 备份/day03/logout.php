...
<!--		<script src="chajian/slide/slide3D-1.2.1.js"></script>
		<script id="scripts">
		    ...
		    var height =document.documentElement.clientHeight/2.6;
		    if(width>=415){
		    	width = document.documentElement.clientWidth/1.1;
		    }
			var mySlide5 = new Slide3D('.fragment', {
...
<!--		<script src="chajian/particle/particle1.js"></script>
		<script>
			var point1;
