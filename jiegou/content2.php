<!--一系列图片（小游戏、音乐、在线字典、todolist、淘宝）及链接（学校官网、友情链接）-->
    	<div class="content2">
    		...
    		<div class="todolist img-hover mask" data-title='微博'>
    			<a href="http://weibo.com/" target="_blank"><img src="img/img/feature/04.106fc8c0.jpg" alt="" /></a>
    		</div>
    					...
    					<div class="marquee-box1">
									<div class="marquee-inner1">
										<ul>
											...
											<li><a href="http://yz.uestc.edu.cn/" target="_blank">电子科大学研招网</a></li>
